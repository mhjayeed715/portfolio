  ...
  return (
    <>
      ...
      <MotionComponent
        ...
        {...props}
      >
        {/* Bend Layer (Backdrop blur with subtle liquid distortion) */}
        <div
          className={`absolute inset-0 ${blurClasses[blurIntensity]} z-0 pointer-events-none bg-white/40 dark:bg-zinc-950/40`}
          style={{
            borderRadius,
        ...
        {/* Face Layer (Main shadow and ambient glow) */}
        <div
        ...
        {/* Edge Layer (Specular crystal inner highlights) */}
        <div
          className="absolute inset-0 z-0 pointer-events-none border border-white/40 dark:border-white/20"
          style={{
            borderRadius,
